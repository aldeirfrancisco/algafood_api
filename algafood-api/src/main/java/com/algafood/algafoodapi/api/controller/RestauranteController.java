...
import com.algafood.algafoodapi.core.validation.ValidacaoException;
...
public class RestauranteController {
    ...
    private void merge(Map<String, Object> dadosOrigem, Restaurante restauranteDestino, HttpServletRequest request) {
        ...
        try {
            ...
            Throwable rooCause = ExceptionUtils.getRootCause(e); // pega a causa principal da exception lancada.
            throw new HttpMessageNotReadableException(e.getMessage(), rooCause, serverHttpRequest);// relancando um
                                                                                                   // exception
        }
    }
}
