...
import com.algafood.algafoodapi.api.controller.EstatisticasController;
import com.algafood.algafoodapi.api.controller.FluxoPedidoController;
...
import com.algafood.algafoodapi.api.controller.GrupoPermissaoController;
import com.algafood.algafoodapi.api.controller.PedidoController;
import com.algafood.algafoodapi.api.controller.PermissaoController;
...
public class AlgaLinks {
    ...
    public Link linkToGrupoPermissoes(String rel) {
        return linkTo(GrupoPermissaoController.class)
                .withRel(rel);
    }
    ...
    public Link linkToUsuarioGrupoDesassociacao(Long usuarioId, Long grupoId, String rel) {
        return linkTo(methodOn(UsuarioGrupoController.class)
                .desassociar(usuarioId, null)).withRel(rel);
    }
    ...
    public Link linkToCancelamentoPedido(Long codigoPedido, String rel) {
        return linkTo(methodOn(FluxoPedidoController.class)
